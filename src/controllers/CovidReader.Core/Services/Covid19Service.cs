...
{
    public class Covid19Service : IRepositoryService<ICovid19Repository>
    {
        private ICovid19Repository _repository;
        ...
        public async Task ImportAsync(ICovid19Repository imports)
        {
        ...
        public async Task ExportAsync(ICovid19Repository exports)
        {
