...
{
    public class ChartConfigService : IRepositoryService<IChartConfigRepository>
    {
        ...
        /// <returns></returns>
        public async Task ImportAsync(IChartConfigRepository imports)
        {
        ...
        /// <returns></returns>
        public async Task ExportAsync(IChartConfigRepository exports)
        {
