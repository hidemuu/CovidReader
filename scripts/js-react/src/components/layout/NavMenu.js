...
export default class NavMenu extends React.Component {
  ...
  render() {
    ...
    const chartsClass = location.pathname.match(/^\/charts/) ? "active" : "";
    const tablesClass = location.pathname.match(/^\/tables/) ? "active" : "";
    const archivesClass = location.pathname.match(/^\/archives/) ? "active" : "";
    const settingsClass = location.pathname.match(/^\/settings/) ? "active" : "";
    
    const navClass = collapsed ? "collapse" : "";
    return (
        <nav class="navbar navbar-inverse navbar-fixed-top text-dark bg-dark" role="navigation">
            <div class="container">
