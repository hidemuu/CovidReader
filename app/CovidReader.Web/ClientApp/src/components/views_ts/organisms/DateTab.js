    ...
    DateTab.prototype.render = function () {
        ...
        return (React.createElement("div", { className: styles_1.default.board },
            React.createElement(core_1.Grid, { container: true, style: { paddingTop: 10, paddingBottom: 10 }, justifyContent: "flex-end", direction: "row" },
                React.createElement(core_1.Grid, { item: true, className: styles_1.default.grid, xs: 9 },
                ...
                React.createElement(core_1.Grid, { item: true, className: styles_1.default.grid, xs: 3 },
