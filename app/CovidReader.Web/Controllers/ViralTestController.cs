...
namespace CovidReader.Web.Controllers
{
    ...
    [ApiController]
    public class ViralTestController : ControllerBase
    {
        private readonly IViralTestRepository _repository;

        public ViralTestController(IViralTestRepository repository)
        {
        ...
        /// </summary>
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] ViralTest item)
        {
        ...
        /// </summary>
        [HttpDelete("{date}")]
        public async Task<IActionResult> Delete(ViralTest item)
        {
