...
namespace CovidReader.WebApi.Controllers
{
    ...
    public class InfectionController : ControllerBase
    {
        ...
        public InfectionController(IInfectionRepository repository)
        {
        ...
        /// </summary>
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] Infection item)
        {
        ...
        /// </summary>
        [HttpDelete("{date}")]
        public async Task<IActionResult> Delete(Infection item)
        {
