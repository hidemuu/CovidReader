...
namespace CovidReader.Web.Controllers
{
    ...
    {
        private readonly IVirusRepository _repository;

        public VirusController(IVirusRepository repository)
        {
        ...
        /// </summary>
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] Virus item)
        {
        ...
        /// </summary>
        [HttpDelete("{date}")]
        public async Task<IActionResult> Delete(Virus item)
        {
